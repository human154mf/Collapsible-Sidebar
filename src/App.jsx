...
export default function Sidebar() {
  ...
  const [openDropdown, setOpenDropdown] = useState(null); // submenu state
    ...
    ${
      activeItem === item.name
        ...
        : "text-gray-300 hover:bg-gray-800"
              ...
              {/* Tooltip kalau sidebar collapsed */}
              {!isOpen && (
                <span
                  className="absolute left-full top-1/2 -translate-y-1/2 ml-2 px-2 py-1 
      ...
      <div className="flex items-center justify-between gap-2 px-7 py-4 border-t border-gray-800">
        {/* Avatar, nama & jabatan hanya muncul kalau sidebar open */}
        {isOpen && (
        ...
        {/* Logout button */}
        <button
          className="relative group rounded-lg hover:bg-gray-800 text-gray-300 hover:text-red-500 transition"
        ...
        >
          ...
          {!isOpen && (
            <span
              className="absolute left-full top-1/2 -translate-y-1/2 ml-2 px-4 py-1
